...
export function MapView({ className = "" }: MapViewProps) {
  const [activeFilter, setActiveFilter] = useState<'Map View' | 'All'>('Map View');


  return (
    <div className={`h-150 w-180 rounded-2xl bg-zinc-900 text-white flex flex-col ${className}`}>
      {/* Header Controls */}
        ...
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="flex space-x-2">
            <Button
              ...
              className={activeFilter === 'Map View' 
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-zinc-700 via-zinc-800 to-zinc-900">
          ...
          <div className="relative h-full overflow-hidden">
            ...
            <svg className="absolute inset-0 w-full h-full opacity-30">
              ...
              {/* Main roads */}
              <path d="M0 200 Q200 180 400 200 T800 200" stroke="#525252" strokeWidth="3" fill="none" opacity="0.8"/>
              <path d="M0 400 Q300 380 600 400 T1200 400" stroke="#525252" strokeWidth="3" fill="none" opacity="0.8"/>
              <path d="M200 0 Q220 200 200 400 T200 800" stroke="#525252" strokeWidth="2" fill="none" opacity="0.6"/>
            </svg>
            ...
            <div className="absolute top-1/2 left-8 transform -translate-y-1/2">
              <div className="bg-zinc-800 rounded-lg p-6 border border-zinc-700 max-w-xs">
                <h3 className="text-white font-medium mb-1">No active bookings</h3>
          ...
          <div className="absolute bottom-20 right-4">
            <button className="w-10 h-10 bg-white rounded-lg shadow-lg flex items-center justify-center text-gray-600 hover:bg-gray-50">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                ...
                <path d="M10 1v4M10 15v4M1 10h4M15 10h4" stroke="currentColor" strokeWidth="2"/>
              </svg>
            </button>
          </div>
        </div>
